...
# mlflow.set_tracking_uri("http://0.0.0.0:5001/") # match this to sql mlflow server --localhost port 5004
mlflow.set_tracking_uri("http://0.0.0.0:5004/")
...
def mlflow_logging(model, X, y, name):
     ...
     with mlflow.start_run() as run:
        ...
        mlflow.set_tracking_uri("http://0.0.0.0:5004/") # always set tracking uri for each run
